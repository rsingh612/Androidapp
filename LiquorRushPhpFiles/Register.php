<?php
    ...
    $zip = $_POST["zip"];
    	...
    	function registerUser() {
 	   	...
 	   	$statement = mysqli_prepare($connect, "INSERT INTO CustomerAccount (name, license, email, password, address, city, state, zip) VALUES(?, ?, ?, ?, ?, ?, ?, ?)");
 	...
 	function usernameAvailable() {
 		...
 		$statement = mysqli_prepare($connect, "SELECT * FROM CustomerAccount WHERE email = ?");
